...
import ug.ktrusilo.javaut.zad05.service.ProducerManager;
...
public class ProducerManagerTest {
	...
	final private String NAME_1 = "Producent1";
	final private String NAME_2 = "Producent2";
	final private String NAME_3 = "Producent3";
	final private String NAME_4 = "Producent4";
	@Autowired
	...
	{
		Producer retProducer = manager.getProducerById(1L);
		List<Producer> list = manager.getAllProducers();
		assertEquals(2, list.size());
		manager.deleteProducer(retProducer);
